...
import io.kimmking.rpcfx.server.RpcfxWork1Invoker;
...
//		registerService(client, orderService);
	...
	@Bean
	public RpcfxWork1Invoker createInvoker(@Autowired RpcfxResolver resolver){
		return new RpcfxWork1Invoker(resolver);
	}
