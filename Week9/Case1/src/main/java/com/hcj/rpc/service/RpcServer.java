    ...
    public Map<String,Object> getService(String clazz){
        try {
            ...
            for(Class<?> cla:classes){
                ...
                services.put(cla.getAnnotation(com.hcj.rpc.service.impl.RpcService.class).value().getName(), obj);
            }
            return services;
        } catch (Exception e) {
        ...
        if (directory.exists()) {
            ...
            for (int i = 0;fileList != null && i < fileList.length; i++) {
                ...
                if (file.isFile() && file.getName().endsWith(".class")) {
                    ...
                    if(clazz.getAnnotation(com.hcj.rpc.service.impl.RpcService.class) != null){
                        classes.add(clazz);
                    }
